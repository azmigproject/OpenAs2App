...
public interface SecurePartnership {
	...
	public static final String PID_X509_SignALIAS = "x509_sign_alias"; // Alias to an X509 Certificate
	public static final String PID_X509_SSLALIAS = "x509_ssl_alias"; // Alias to an X509 Certificate
