...
public class AsynchMDNSenderModule extends HttpSenderModule {
	...
	private void sendAsyncMDN(AS2Message msg, Map<Object, Object> options)
		...
		try {
			...
			if(msg.getPartnership().getSenderID(SSL_CLIENT_CERTIFICATE)!=null && msg.getPartnership().getSenderID(SSL_CLIENT_CERTIFICATE_PASSWORD)!=null && msg.getPartnership().getReceiverID(SSL_CLIENT_CERTIFICATE)!="" && msg.getPartnership().getReceiverID(SSL_CLIENT_CERTIFICATE_PASSWORD)!="" )
			{
